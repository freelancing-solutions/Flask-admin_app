...
class Config:
    ...
    GET_MEMBERSHIP_PLANS_ENDPOINT: str = os.getenv('get_membership_plans_endpoint') \
                                         or config('get_membership_plans_endpoint')
    ...
    SEND_ADD_EXCHANGE_DATA_ENDPOINT = os.getenv('send_add_exchange_data_endpoint') or \
                                      config('send_add_exchange_data_endpoint')
    ...
    SEND_AFFILIATE_DATA_ENDPOINT: str = os.getenv('send_affiliate_data_endpoint') or \
                                        config('send_affiliate_data_endpoint')
    SEND_USER_DATA_ENDPOINT: str = os.getenv('send_user_data_endpoint') or config('send_user_data_endpoint')
    SEND_MEMBERSHIP_DATA_ENDPOINT: str = os.getenv('send_membership_data_endpoint') or \
                                         config('send_membership_data_endpoint')
    SEND_MEMBERSHIP_PLAN_ENDPOINT: str = os.getenv('send_membership_plan_endpoint') or \
                                         config('send_membership_plan_endpoint')
